...
RUN conda env create --file /home/docker/my_environment.yml -n deep_learning
RUN echo "source activate deep_learning" > ~/.bashrc
ENV PATH /opt/conda/envs/deep_learning/bin:$PATH
